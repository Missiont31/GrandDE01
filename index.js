...
function startCalculating() {
    ...
    if (reasonText.length <= 100) {
        characterResult.innerHTML = `<b>Zeichen:</b> ${reasonText.length}/100`
    } else {
        characterResult.innerHTML = `<b>Zeichen:</b> <font style="color: red;">${reasonText.length}/100<br>Schalte den Kurzen Grund an!</font>`
    }
